...
<div class="offcanvas offcanvas-end" id="addPaymentOffcanvas" aria-hidden="true">
  ...
  <div class="offcanvas-body flex-grow-1">
    <div class="d-flex justify-content-between bg-lighter p-2 mb-3">
      ...
      <p class="fw-medium mb-0"><?php echo e(number_format(abs($payment->total_due - $payment->valor), 2, ',', '.')); ?></p>
    </div>
    <form action="<?php echo e(route('addPayment')); ?>" method="POST" onsubmit="showLoadingModal()">
      <?php echo csrf_field(); ?>
...
</div><?php /**PATH /www/wwwroot/developer.veetv.fun/resources/views/_partials/_offcanvas/offcanvas-add-payment.blade.php ENDPATH**/ ?>