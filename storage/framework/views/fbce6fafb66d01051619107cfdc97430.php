<?php $__env->startSection('title', 'Créditos'); ?>
...
<script>
    var loadDataUrl = '<?php echo e(route('revenda.list')); ?>';
    var destroyMultipleUrl = '<?php echo e(route('revenda.destroyMultiple')); ?>';
    var label_update = '<?php echo e(__('messages.update')); ?>';
    var label_delete = '<?php echo e(__('messages.delete')); ?>';
</script>
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src="<?php echo e(asset('assets/js/pages/revenda_planos.js')); ?>"></script>
<script>
  document.addEventListener('DOMContentLoaded', function () {
      ...
      const rendasCreditos = <?php echo json_encode($rendas_creditos, 15, 512) ?>;
...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid">
        ...
        <h4 class="py-3 mb-2">
            <span class="text-muted fw-light"><?php echo e(config('variables.templateName', 'TemplateName')); ?> / </span> Créditos
        </h4>
            ...
            <div class="card-body">
                <div class="table-responsive text-nowrap">
                    ...
                    <table id="table" data-toggle="table" data-loading-template="loadingTemplate"
                        data-url="<?php echo e(route('revenda.list')); ?>" data-icons-prefix="bx" data-icons="icons"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th data-field="creditos" data-visible="<?php echo e(in_array('creditos', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>" data-sortable="true">Créditos</th>
                                <th data-field="preco" data-visible="<?php echo e(in_array('preco', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>" data-sortable="true">Preço por Crédito</th>
                                <th data-field="total" data-visible="<?php echo e(in_array('total', $visibleColumns) || empty($visibleColumns) ? 'true' : 'false'); ?>" data-sortable="true">Total</th>
            ...
            <div class="modal-dialog modal-lg modal-simple modal-add-credito">
                <div class="modal-content p-3 p-md-5">
                    <div class="modal-body">
                        ...
                        <form id="addCreditoForm" class="row g-3" action="<?php echo e(route('revenda.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="col-12">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/layoutMaster', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /www/wwwroot/gestor.veetv.fun/resources/views/revenda/index.blade.php ENDPATH**/ ?>